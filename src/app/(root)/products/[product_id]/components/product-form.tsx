...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const form = useForm<ProductFormInput>({
    ...
    defaultValues: initialData
      ? {
          ...initialData,
          price: parseFloat(String(initialData?.sale_price)),
        }
      : {
          name: "",
          images: [],
        ...
        <form
          ...
          <div className="grid grid-cols-3 gap-8">
                  ...
                  <FormItem className="w-28">
                    ...
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        // onChange={() => {
                        //   if (field.value <= -1) return field.onChange(0);
            ...
            <FormField
              ...
              name="isFeatured"
              render={({ field }) => (
                <FormItem className="place-self-start flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  <FormControl>
                    <Checkbox
                      checked={field.value}
              ...
              render={({ field }) => (
                <FormItem className="place-self-start flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Este producto no aparecerá en niguna parte de la página
                    </FormDescription>
                  </div>
                </FormItem>
              )}
